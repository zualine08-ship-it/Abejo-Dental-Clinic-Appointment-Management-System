...
// AdminSeeder - Test data for development
const AdminSeeder = {
          ...
          <div>
            ...
            <form
              onSubmit={async (e) => {
                ...
                try {
                  ...
                  const user = await login(email, password, isChecked);

                  console.log("Sign in successful");
                  
                  showToast("You have signed in successfully.", "success", 2000);
                  ...
                  showToast(errorMessage || "Sign in failed. Please try again.", "error");
                } finally {
                  setIsLoading(false);
                }
              }}
            >
              <div className="space-y-6">
                {error && (
                  <div className="p-3 text-sm text-error-600 bg-error-100 rounded-lg dark:bg-error-900/20 dark:text-error-400">
                    {error}
                  </div>
                )}
                <div>
